...
},{"./Promise.prototype.finally":11,"promise-polyfill":1}],11:[function(require,module,exports){
"use strict";
...
(function () {
  ...
  window.showSpeedPromo = function () {
    ...
    return mode === 'proxy' || Boolean(filters.find(function (_ref) {
  ...
  if (congratsTabId) {
    tabOpenPromise = Browser.tabs.query().then(function (tabs) {
      return Boolean(tabs.find(function (_ref2) {
        var id = _ref2.id;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            return _context2.abrupt('return', proxy.setState({ 'broken': false }).then(function () {
              return true;
            }));
...
},{"polyfills/Array.from":2,"polyfills/Array.prototype.find":3,"polyfills/Array.prototype.findIndex":4,"polyfills/Array.prototype.includes":5,"polyfills/Element.append":6,"polyfills/Element.matches":7,"polyfills/Element.prepend":8,"polyfills/Object.assign":9,"polyfills/Promise":10,"polyfills/String.prototype.endsWith":12,"polyfills/String.prototype.includes":13,"polyfills/String.prototype.padEnd":14,"polyfills/String.prototype.padStart":15,"polyfills/String.prototype.startsWith":16,"polyfills/regeneratorRuntime":17}]},{},[18]);
